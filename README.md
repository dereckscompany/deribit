...
swing. Because so much of that activity happens in one place, it is the
best window into what traders collectively expect the market to do next,
including a single headline gauge, the DVOL index, that summarises how
nervous or calm the options market is. This package pulls Deribit’s
